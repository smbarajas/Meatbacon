/*
 Created an application which manages an inventory of products. Create a product class which keeps track of
 price, id, and quantity. Then, made an inventory class which keeps track of various products and will sum up inventory value.
 */
